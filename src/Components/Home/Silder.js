      ...
      <Carousel.Item className="slider-background" interval={2000}>
        <Row className="d-flex flex-row justify-content-center align-items-center">
          ...
          <div className="relative z-20 text-center text-white px-4">
            <h1
              className="text-4xl md:text-6xl font-bold mb-4 leading-tight cor"
              style={{ color: "var(--text-color)" }}
            >
              Luxury in Every Step
            </h1>
            <p
              className="text-lg md:text-xl fs-5 cor text-gray-300 mb-5"
              style={{ color: "var(--text-color)" }}
            >
        ...
        <Row className="d-flex flex-row justify-content-center align-items-center">
          <img
            style={{
              height: "296px",
              width: "500.53px",
              filter: "drop-shadow(0 0 10px rgb(17, 223, 255))",
            }}
            className=""
            src={prod3}
            alt="First slide"
