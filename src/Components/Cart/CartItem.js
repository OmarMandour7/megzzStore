...
import mobile from '../../images/ah.png'
const CartItem = () => {
    return (
        <Col xs="12" className="cart-item-body my-5  d-flex flex-column flex-md-row  px-2">
        ...
        <div className="w-100">
          ...
          <Row className="justify-content-center mt-2">
            <Col sm="12" className=" d-flex flex-row justify-content-start">
              <div className="d-inline pt-2 cart-title">
              Air Max 270
              </div>
          ...
          <Row>
             <Col sm="12" className="mt-1 d-flex">
                        ...
                        style={{ backgroundColor: "Black" , color:"White"}}>40</div>
                        </Col>
          </Row>
          <Row className="justify-content-between">
            <Col sm="12" className=" d-flex flex-row justify-content-between">
